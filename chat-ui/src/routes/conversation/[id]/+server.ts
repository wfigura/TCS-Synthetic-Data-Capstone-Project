		...
		async start(controller) {
			...
			try {
				...
				const BiasMessageId = addChildren(
					...
					{
						from: "user",
						content: `Here is the response generated by Model A: "${messageToWriteTo.content}". Please tell me of any potential bias in this response.  Also Determine the Summary Statistics for the Synthetic Data Manually and just provide them to me`,
						createdAt: new Date(),
						updatedAt: new Date(),
					},
					UserMessageId
				...
				messagesForPrompt = buildSubtree(conv, UserMessageId);
